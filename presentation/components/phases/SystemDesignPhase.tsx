...
export const SystemDesignPhase = ({ document, onUpdate }: PhaseProps) => {
    ...
    // Auto-generate if no architecture exists yet
    useEffect(() => {
        if (!document.systemDesign?.architectureDiagramMermaid && !hasAutoGenerated && !isGenerating) {
            setHasAutoGenerated(true);
            handleGenerate();
        }
    }, [document.systemDesign?.architectureDiagramMermaid, hasAutoGenerated, isGenerating]);
