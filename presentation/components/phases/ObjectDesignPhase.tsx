...
export const ObjectDesignPhase = ({ document, onUpdate }: PhaseProps) => {
    ...
    // Auto-generate if no class diagram exists yet
    useEffect(() => {
        if (!document.objectDesign?.classDiagramMermaid && !hasAutoGenerated && !isGenerating) {
            setHasAutoGenerated(true);
            handleGenerate();
        }
    }, [document.objectDesign?.classDiagramMermaid, hasAutoGenerated, isGenerating]);
